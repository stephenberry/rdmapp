...
namespace rdmapp
{
   struct deserialized_qp
   {
      struct qp_header
      {
         static constexpr size_t kSerializedSize = sizeof(uint16_t) + 3 * sizeof(uint32_t);
         uint16_t lid;
         uint32_t qp_num;
         uint32_t sq_psn;
   ...
   struct queue_pair : public noncopyable, public std::enable_shared_from_this<queue_pair>
   {
     ...
     public:
       ...
       */
      void post_send(const ibv_send_wr& send_wr, ibv_send_wr*& bad_send_wr);
       ...
       * first work request that failed to post.
       */
      void post_recv(const ibv_recv_wr& recv_wr, ibv_recv_wr*& bad_recv_wr) const;
       ...
       */
      [[nodiscard]] send_awaitable write(const remote_mr& remote_mr, void* buffer, size_t length);
       ...
       * @return send_awaitable A coroutine returning length of the data written.
       */
      [[nodiscard]] send_awaitable write_with_imm(const remote_mr& remote_mr, void* buffer, size_t length,
                                                  uint32_t imm);
       ...
       */
      [[nodiscard]] send_awaitable read(const remote_mr& remote_mr, void* buffer, size_t length);
       ...
       * @return send_awaitable A coroutine returning length of the data sent.
       */
      [[nodiscard]] send_awaitable fetch_and_add(const remote_mr& remote_mr, void* buffer, size_t length, uint64_t add);
       ...
       * @return send_awaitable A coroutine returning length of the data sent.
       */
      [[nodiscard]] send_awaitable compare_and_swap(const remote_mr& remote_mr, void* buffer, size_t length,
       ...
       * @return send_awaitable A coroutine returning length of the data written.
       */
      [[nodiscard]] send_awaitable write(const remote_mr& remote_mr, std::shared_ptr<local_mr> local_mr);
       ...
       * @return send_awaitable A coroutine returning length of the data sent.
       */
      [[nodiscard]] send_awaitable write_with_imm(const remote_mr& remote_mr, std::shared_ptr<local_mr> local_mr,
                                                  uint32_t imm);
       ...
       * @return send_awaitable A coroutine returning length of the data read.
       */
      [[nodiscard]] send_awaitable read(const remote_mr& remote_mr, std::shared_ptr<local_mr> local_mr);
       ...
       * @return send_awaitable A coroutine returning length of the data sent.
       */
      [[nodiscard]] send_awaitable fetch_and_add(const remote_mr& remote_mr, std::shared_ptr<local_mr> local_mr,
                                                 uint64_t add);
       ...
       * @return send_awaitable A coroutine returning length of the data sent.
       */
      [[nodiscard]] send_awaitable compare_and_swap(const remote_mr& remote_mr, std::shared_ptr<local_mr> local_mr,
                                                    uint64_t compare, uint64_t swap);
     ...
     private:
       ...
       * @param bad_recv_wr
       */
      void post_recv_rq(const ibv_recv_wr& recv_wr, ibv_recv_wr*& bad_recv_wr) const;
       ...
       * @param bad_recv_wr
       */
      void post_recv_srq(const ibv_recv_wr& recv_wr, ibv_recv_wr*& bad_recv_wr) const;
   };
